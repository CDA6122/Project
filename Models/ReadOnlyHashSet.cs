...
namespace Project.Models
{
    ...
    internal sealed class ReadOnlyHashSet<T> : IReadOnlyHashSet<T>
    {
        ...
        public bool Add(T item) => throw new NotSupportedException(ErrorCollectionIsReadOnly);
        public void Clear() => throw new NotSupportedException(ErrorCollectionIsReadOnly);
        ...
        public void ExceptWith(IEnumerable<T> other) => throw new NotSupportedException(ErrorCollectionIsReadOnly);
        public IEnumerator<T> GetEnumerator() => set.GetEnumerator();
        public void IntersectWith(IEnumerable<T> other) => throw new NotSupportedException(ErrorCollectionIsReadOnly);
        public bool IsProperSubsetOf(IEnumerable<T> other) => set.IsProperSubsetOf(other);
        public bool IsProperSupersetOf(IEnumerable<T> other) => set.IsProperSupersetOf(other);
        public bool IsSubsetOf(IEnumerable<T> other) => set.IsSubsetOf(other);
        public bool IsSupersetOf(IEnumerable<T> other) => set.IsSupersetOf(other);
        public bool Overlaps(IEnumerable<T> other) => set.Overlaps(other);
        public bool Remove(T item) => throw new NotSupportedException(ErrorCollectionIsReadOnly);
        public bool SetEquals(IEnumerable<T> other) => set.SetEquals(other);
        public void SymmetricExceptWith(IEnumerable<T> other) => throw new NotSupportedException(ErrorCollectionIsReadOnly);
